...
enum rawrtc_code {
    ...
    RAWRTC_CODE_CERTIFICATE_ERROR,
    RAWRTC_CODE_SCTP_TRANSPORT_ERROR,
    RAWRTC_CODE_DF_ERROR,
    RAWRTC_CODE_UNKNOWN_RE_ERROR,
    RAWRTC_CODE_PEER_CONNECTION_ERROR,
    RAWRTC_CODE_PEER_CONNECTION_DESC_ERROR
